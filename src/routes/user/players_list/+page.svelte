...
<!-- component -->
<div class="backdrop-blur-md bg-white/50 p-8 rounded-md w-full">
	...
	<div class="flex ml-2 justify-items-end">
		...
		<div class="lg:ml-4 ml-10">
			<button
				class="bg-white/70 px-4 py-2 rounded-md text-white font-bold tracking-wide cursor-pointer text-xl text-emerald-500 shadow-md"
			>
				<svg
					data-slot="icon"
					fill="none"
					...
					xmlns="http://www.w3.org/2000/svg"
					aria-hidden="true"
					class="w-6 h-6 font-bold text-xl"
				>
			...
			<div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
				<table class="min-w-full leading-normal">
					<thead>
						<tr>
							<th
								class="px-5 py-3 border-b-2 border-gray-200 bg-opacity-50 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider"
							>
								Name
							</th>
							<th
					...
					<tbody>
						<tr class=" border-2 border-indigo-500">
							<td class="px-5 py-5 border-b border-gray-200 bg-opacity-50 bg-white text-sm">
				...
				<div
					class="px-5 py-5 bg-red-800 border-t flex flex-col xs:flex-row items-center xs:justify-between"
				>
