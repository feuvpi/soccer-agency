		...
		<div class="flex flex-col lg:flex-row justify-between">
			<div class="mb-10 lg:mb-0">
				...
				<p class="font-normal text-gray-500 text-xs md:text-base">
					I have brought here my biggest and favorite works <br /> as a professional.
				</p>
			</div>
				...
				<div class="flex space-x-6">
					...
					<div>
						...
						<p class="font-normal text-gray-500 text-sm md:text-base">
							A dummy data free and documented API generator to facilitate <br /> the process of testing
							the front-end portion of projects.
						</p>
					</div>
				</div>
	...
	<div class="container max-w-screen-xl mx-auto px-4">
		<div class="text-center">
			...
			<p class="font-medium text-gray-700 text-xs md:text-base">
				...
				front-end projects. I’m an avid programmer, so I create designs based on the <br /> weekend @figmadesign.
			</p>
		</div>
	</div>
</section>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
			<div class="bg-gray-50 px-8 py-10 rounded-md">
				...
				<h6 class="font-semibold text-gray-500 text-md">
					Stephan Clark <span class="font-medium text-gray-300 text-sm">- CEO at EarlyBird</span>
				</h6>
			</div>
	...
	<div class="container max-w-screen-xl mx-auto px-4">
		<div class="text-center">
			...
			<p class="font-normal text-gray-400 text-md md:text-lg mb-20">
				I’m not currently taking on new client work but feel free to contact me for any <br /> other
				inquiries.
			</p>
